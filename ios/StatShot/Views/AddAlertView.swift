...
private struct TriggerStep: View {
    ...
    /// Called when the user picks a player from the "Browse Players" roster.
    /// The parent view should transition to a new TriggerStep for that player.
